...
public class AiRecommendationService {
    ...
    public List<Long> recommendCouponIds(RecommendRequest recommendRequest) {
        String prompt = "Based on the keywords " + recommendRequest.getKeywords() +
                ", recommend up to 5 coupon IDs from the following list:\n" +
                recommendRequest.getCoupons().stream()
        ...
        return extractRecommendedIds(response);
    }
